...
from vesuvius_challenge_rnd.scroll_ink_detection.ink_detection.data import (
...
def run_inference(
    ...
    if isinstance(model_cls, str):
        ...
        model = _load_model(model_ckpt_path, model_cls_path, strict=False)
    else:
    ...
    # Load data module.
    data_module = ScrollPatchDataModuleEvalMmap(
    ...
    orig_h, orig_w = data_module.segment.surface_shape
