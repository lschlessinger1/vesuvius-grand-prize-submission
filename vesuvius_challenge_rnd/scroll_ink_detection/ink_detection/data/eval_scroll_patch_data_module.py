...
class EvalScrollPatchDataModule(BasePatchDataModule):
    ...
    Attributes:
        segment (ScrollSegment): A scroll segment.
        data_predict (ScrollPatchDataset): Dataset for the prediction stage.
        data_dir (Path): Directory containing the scroll data. Defaults to SCROLL_DATA_DIR.
    ...
    def __init__(
        ...
        Args:
            segment (ScrollSegment): A scroll segment.
            data_dir (Path, optional): Directory containing the scroll data. Defaults to SCROLL_DATA_DIR.
    ...
    def setup(self, stage: str) -> None:
        ...
        if stage == "predict" or stage is None:
            self.data_predict = ScrollPatchDataset(
                [self.segment],
    ...
    def predict_transform(self) -> A.Compose:
        ...
        transforms += [A.Normalize(mean=[0], std=[1]), ToTensorV2()]
