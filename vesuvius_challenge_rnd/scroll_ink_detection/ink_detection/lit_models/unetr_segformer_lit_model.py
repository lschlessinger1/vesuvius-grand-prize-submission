...
from vesuvius_challenge_rnd.scroll_ink_detection.ink_detection.models import UNETRSegformer
from vesuvius_challenge_rnd.scroll_ink_detection.ink_detection.schedulers import (
    GradualWarmupSchedulerV2,
)


class UNETRSegformerPLModel(LightningModule):
    def __init__(
        self,
