...
from vesuvius_challenge_rnd.scroll_ink_detection.ink_detection.models.mednext.mednextv1_segformer import (
    MedNextV1Segformer,
)
...
class MedNextV1SegformerPLModel(LightningModule):
    def __init__(
        self,
        ...
        self.model = MedNextV1Segformer(
            in_channels=in_channels,
            mednextv1_model_id=mednextv1_model_id.upper(),
