...
from vesuvius_challenge_rnd.scroll_ink_detection.ink_detection.models.mednext.create_mednext_v1_3d_to_2d import (
    create_mednext_v1_3d_to_2d,
)
...
class MedNextV13dto2dPLModel(LightningModule):
    def __init__(
        self,
        ...
        self.model = create_mednext_v1_3d_to_2d(
            num_input_channels=in_channels,
            num_classes=1,
            model_id=mednextv1_model_id.upper(),
