...
from vesuvius_challenge_rnd.scroll_ink_detection.ink_detection.models import UNet3DSegformer
from vesuvius_challenge_rnd.scroll_ink_detection.ink_detection.schedulers import (
    GradualWarmupSchedulerV2,
)


class UNet3dSegformerPLModel(LightningModule):
    def __init__(
        self,
        ...
        self.model = UNet3DSegformer(
            in_channels=in_channels,
            img_size=(z_extent, self.size, self.size),
            unet_feature_size=unet_feature_size,
            unet_out_channels=unet_out_channels,
            unet_module_type=unet_module_type,
            segformer_model_size=segformer_model_size,
