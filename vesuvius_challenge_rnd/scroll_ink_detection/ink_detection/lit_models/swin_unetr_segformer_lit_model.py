...
from vesuvius_challenge_rnd.scroll_ink_detection.ink_detection.models import SwinUNETRSegformer
from vesuvius_challenge_rnd.scroll_ink_detection.ink_detection.schedulers import (
    GradualWarmupSchedulerV2,
)


class SwinUNETRSegformerPLModel(LightningModule):
    def __init__(
        self,
