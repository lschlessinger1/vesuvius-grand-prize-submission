...
from vesuvius_challenge_rnd.scroll_ink_detection.ink_detection.models import HrSegNetB16Model
from vesuvius_challenge_rnd.scroll_ink_detection.ink_detection.schedulers import (
    GradualWarmupSchedulerV2,
)


class HrSegNetLitModel(LightningModule):
    def __init__(
        self,
        ...
        self.encoder_3d = HrSegNetB16Model(in_channels=in_channels, num_classes=1, base=base)
