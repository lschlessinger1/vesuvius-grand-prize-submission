...
class CNN3DUnetPlusPlusEfficientNet(nn.Module):
    def __init__(self, in_channels: int = 1, n_classes: int = 1, efficient_net_size: int = 5):
        super().__init__()
        ...
        self.xy_encoder_2d = smp.UnetPlusPlus(
            encoder_name=f"timm-efficientnet-b{efficient_net_size}",
